                  ...
                  <CardContent>
                    ...
                    {pyq.fileId ? (
                      <Button
                        className="w-full"
<<<<<<< HEAD
                        onClick={() => handleDownload(pyq.type || 'pyqs', pyq._id, pyq.fileId)}
                      >
                ...
                <Card key={cert._id} className="hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      {cert.fileId && (
<<<<<<< HEAD
                        <Button className="w-full" onClick={() => handleDownload(cert.type || 'certifications', cert._id, cert.fileId)}>
                          <Download className="w-4 h-4 mr-2" />
                          Download
=======
                ...
                <Card key={hackathon._id} className="hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      {hackathon.fileId && (
<<<<<<< HEAD
                        <Button className="w-full" onClick={() => handleDownload(hackathon.type || 'hackathons', hackathon._id, hackathon.fileId)}>
                          <Download className="w-4 h-4 mr-2" />
                          Download
=======
                        <Button className="w-full" asChild disabled={!isLoggedIn}>
                ...
                <Card key={interview._id} className="hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      {interview.fileId && (
<<<<<<< HEAD
                        <Button className="w-full" onClick={() => handleDownload(interview.type || 'interviews', interview._id, interview.fileId)}>
                          <Download className="w-4 h-4 mr-2" />
                          Download
                        </Button>
=======
